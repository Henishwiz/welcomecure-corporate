...
const TrustedBy = ({ data }: { data: trustedBy }) => {
    return (
        <section className='container mx-auto px-4'>
            ...
            <section className='columns-1 md:columns-2 lg:columns-3 gap-4 xl:gap-5'>
                {data.reviews?.map((item, index) => (
                    <div key={index} className='break-inside-avoid mb-4 xl:mb-5 bg-[#F4F4F4] p-2.5 lg:p-5 rounded-[10px]'>
