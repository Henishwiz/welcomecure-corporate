    ...
    return (
        <section className='relative'>
            ...
            <div className='absolute top-0 left-0 w-full h-full flex flex-col text-center justify-center items-center'>
                ...
                <p className='text-white text-base lg:text-lg font-medium max-w-md lg:max-w-4xl text-center mt-[15px] mb-[25px] px-4'>{hero.subtitle}</p>
                <div className='flex flex-col lg:flex-row gap-5 items-center font-normal text-base px-4 w-full sm:w-auto'>
                    {hero.primaryCta && (
