        ...
        <section className='bg-[#FAE006]'>
            <footer className='bg-[#1A1A1A] relative clip-curve-bottom pt-[73px] lg:pt-[106px]'>
                ...
                <section>
                    ...
                    <h3 className='text-white text-[32px] lg:text-[58px] font-bold text-center max-w-xs md:max-w-[676px] mx-auto Amiko-Bold'>{data.heading}</h3>
                    ...
                    <section className='lg:border-t border-[#4E545F] py-2.5'>
                        <section className='xl:container xl:mx-auto flex flex-col lg:flex-row items-center justify-between gap-y-5 lg:gap-y-0'>
                            <p className='order-2 lg:order-1 text-white text-xs sm:text-base font-normal text-center lg:text-left w-full px-4'>100% Secure Payments<br />All major credit & debit cards accepted</p>
