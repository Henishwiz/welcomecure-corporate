...
const Header = ({ data }) => {
  ...
  return /* @__PURE__ */ jsxs("header", { className: "bg-white py-[17px] fixed top-0 z-30 right-0 left-0 shadow-md", children: [
    /* @__PURE__ */ jsxs("section", { className: "xl:container xl:mx-auto px-2.5 flex justify-between items-center", children: [
      /* @__PURE__ */ jsx(
        "img",
        {
          src: data?.logo,
      ...
      /* @__PURE__ */ jsxs("ul", { className: "hidden lg:flex gap-x-[30px] items-center font-normal text-base text-black", children: [
        ...
        data.menuItems.map((item, idx) => /* @__PURE__ */ jsxs("li", { className: "relative group cursor-pointer", children: [
          /* @__PURE__ */ jsxs("a", { href: item.url, className: "flex items-center gap-1", children: [
            item.label,
            item.subItems?.length > 0 && /* @__PURE__ */ jsx(
              "img",
              {
          ...
          item.subItems?.length > 0 && /* @__PURE__ */ jsx("ul", { className: "absolute z-10 left-0 top-full mt-2 w-48 bg-white shadow-md rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition duration-300 overflow-hidden", children: item.subItems.map((sub, subIdx) => /* @__PURE__ */ jsx(
            "li",
            {
      ...
      /* @__PURE__ */ jsxs("ul", { className: "hidden lg:flex gap-x-2.5 items-center font-normal text-base text-black", children: [
        /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("button", { className: "outline outline-[#FAE006] rounded-md p-2.5 leading-none", children: data.loginText }) }),
        /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("button", { className: "bg-[#FAE006] rounded-md p-2.5 leading-none", children: data.registerText }) })
      ] })
    ] }),
    /* @__PURE__ */ jsx(Transition, { appear: true, show: isOpen, as: Fragment, children: /* @__PURE__ */ jsx(Dialog, { as: "div", className: "fixed inset-0 z-50 overflow-hidden lg:hidden", onClose: () => setIsOpen(false), children: /* @__PURE__ */ jsx(
      Transition.Child,
      {
        as: Fragment,
        ...
        children: /* @__PURE__ */ jsxs(Dialog.Panel, { className: "h-full bg-white overflow-y-auto text-left transform transition-all", children: [
          ...
          /* @__PURE__ */ jsxs("ul", { className: "flex flex-col gap-y-4 font-medium text-black", children: [
            /* @__PURE__ */ jsx("li", { children: "Products" }),
            /* @__PURE__ */ jsx("li", { children: "Services" }),
            /* @__PURE__ */ jsx("li", { children: "Resources" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-auto flex flex-col gap-2", children: [
            /* @__PURE__ */ jsx("button", { className: "outline outline-[#FAE006] rounded-md p-2.5 leading-none", children: "Log In" }),
            /* @__PURE__ */ jsx("button", { className: "bg-[#FAE006] rounded-md p-2.5 leading-none", children: "Register" })
          ] })
        ] })
      }
    ) }) })
...
const Footer = ({ data }) => {
  return /* @__PURE__ */ jsx("section", { className: "bg-[#FAE006]", children: /* @__PURE__ */ jsx("footer", { className: "bg-[#1A1A1A] relative clip-curve-bottom pt-[106px]", children: /* @__PURE__ */ jsxs("section", { children: [
    /* @__PURE__ */ jsx("h3", { className: "text-white text-[58px] font-bold text-center max-w-[696px] mx-auto Amiko-Bold", children: data.heading }),
    /* @__PURE__ */ jsx("p", { className: "text-white text-lg font-normal text-center my-10 max-w-[696px] mx-auto", children: data.subheading }),
    /* @__PURE__ */ jsxs("section", { className: "flex items-center justify-center gap-x-5", children: [
      /* @__PURE__ */ jsx("input", { type: "text", placeholder: "Enter your email", className: "w-[292px] rounded-md py-2.5 px-[15px] text-black leading-none outline-none bg-white" }),
      /* @__PURE__ */ jsx("button", { className: "bg-[#FAE006] rounded-md py-2.5 px-[15px] text-black leading-none", children: "Get Notified" })
    ] }),
    /* @__PURE__ */ jsxs("section", { className: "grid grid-cols-12 pt-[70px] pb-[79px] xl:container xl:mx-auto", children: [
      /* @__PURE__ */ jsxs("ul", { className: "col-span-5 w-max", children: [
        ...
        /* @__PURE__ */ jsx("a", { href: `tel:${data.contactInfo.phone}`, className: "w-max", children: /* @__PURE__ */ jsx("li", { className: "text-white text-base font-normal my-[34px]", children: data.contactInfo.phone }) }),
        /* @__PURE__ */ jsx("li", { className: "flex items-center gap-x-2.5", children: data.socialLinks.map((social, index) => /* @__PURE__ */ jsx("a", { href: social.url, children: /* @__PURE__ */ jsx("img", { src: social.icon, alt: "Social Link", className: "object-cover" }, index) }, index)) })
      ] }),
      /* @__PURE__ */ jsx("section", { className: "grid grid-cols-3 col-span-7 gap-[43px]", children: data.footerLinks.map((section, index) => /* @__PURE__ */ jsxs("div", { className: "col-span-1 text-start", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-white text-base font-light mb-[25px]", children: section.title }),
        /* @__PURE__ */ jsx("ul", { className: "flex flex-col gap-y-[15px]", children: section.links.map((link, index2) => /* @__PURE__ */ jsx("li", { className: "text-white text-base font-normal", children: link.url ? /* @__PURE__ */ jsx("a", { href: link.url, children: link.label }) : link.label }, index2)) })
      ] }, index)) })
    ] }),
    /* @__PURE__ */ jsx("section", { className: "border-t border-[#4E545F] py-2.5", children: /* @__PURE__ */ jsxs("section", { className: "xl:container xl:mx-auto flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("p", { className: "text-white text-base font-normal", children: [
        "100% Secure Payments",
        /* @__PURE__ */ jsx("br", {}),
        "All major credit & debit cards accepted"
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex items-center gap-x-2.5", children: data.paymentMethods.map((paymentMethod, index) => /* @__PURE__ */ jsx("img", { src: paymentMethod.icon, alt: "Payment Method", className: "object-cover" }, index)) })
    ] }) }),
    /* @__PURE__ */ jsx("section", { className: "text-white text-base leading-[28px] font-normal border-y border-[#4E545F] py-2.5", children: /* @__PURE__ */ jsxs("section", { className: "xl:container xl:mx-auto flex items-center justify-between", children: [
      /* @__PURE__ */ jsx("h2", { className: "", children: data.copyright }),
      /* @__PURE__ */ jsx("div", { className: "flex items-center gap-x-2.5", children: data.legalLinks.map((link, index) => /* @__PURE__ */ jsx("a", { href: link.url, className: `text-white text-base font-normal ${index !== data.legalLinks.length - 1 ? "border-r border-[#4E545F] pr-2.5" : ""}`, children: link.label }, index)) })
    ] }) })
  ] }) }) });
};
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" data-astro-cid-sckkx6r4> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.ico"><link rel="sitemap" href="/sitemap-index.xml"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title><meta name="description"${addAttribute(description, "content")}>${og && renderTemplate`${renderComponent($$result, "Fragment", Fragment$1, { "data-astro-cid-sckkx6r4": true }, { "default": async ($$result2) => renderTemplate`<meta property="og:title"${addAttribute(og.ogTitle, "content")}><meta property="og:description"${addAttribute(og.ogDescription, "content")}>${og.ogImage && renderTemplate`<meta property="og:image"${addAttribute(og.ogImage, "content")}>`}` })}`}${twitter && renderTemplate`${renderComponent($$result, "Fragment", Fragment$1, { "data-astro-cid-sckkx6r4": true }, { "default": async ($$result2) => renderTemplate`<meta name="twitter:title"${addAttribute(twitter.twitterTitle, "content")}><meta name="twitter:description"${addAttribute(twitter.twitterDescription, "content")}>${twitter.twitterImage && renderTemplate`<meta name="twitter:image"${addAttribute(twitter.twitterImage, "content")}>`}` })}`}${renderHead()}</head> <body data-astro-cid-sckkx6r4> ${renderComponent($$result, "Header", Header, { "data": headerData, "data-astro-cid-sckkx6r4": true })} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", Footer, { "data": footerData, "data-astro-cid-sckkx6r4": true })} </body></html>`;
